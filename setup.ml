...
(* OASIS_START *)
(* DO NOT EDIT (digest: e7fac5825b8569f4ef409f6b2257fe16) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/ruhatch/mirage-ir";
          synopsis =
            "A simple information retrieval library on top of mirage-block-fs";
          description =
            Some
              [
                 OASISText.Para
                   "A simple information retrieval libarary on top of mirage-block-fs"
              ];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "^B\157Çe´ö£\000êX40 M×";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
